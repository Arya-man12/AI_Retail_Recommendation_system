def dashboard_payload() -> dict:
    return {
        ...
        "signals": [
            {
                "title": "Cart recovery lift",
                "detail": "Personalized bundle offers are outperforming baseline by 12%.",
                "intent": "good",
            },
            {
                "title": "Northeast surge",
                "detail": "Demand clustering around premium replenishment products.",
                "intent": "good",
            },
            {
                "title": "Inventory watch",
                "detail": "Two recommended SKUs may stock out within 36 hours.",
                "intent": "warn",
            },
        ],
        "recommendations": [
